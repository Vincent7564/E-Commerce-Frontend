      ...
      <div>
        <div className="grid grid-cols-2 gap-2">
          ...
          <div className="py-5 px-1">
            <h1 className="text-4xl font-medium py-1">
              ...
              {products.discount && products.discount.$numberDecimal > 0 ? (
                <>
                  <p className=" text-red-400">
                    <div className="w-[50%] text-m font-bold bg-red-500 text-red-300 text-right">
                      {products.discount.$numberDecimal}% OFF!!!
                    </div>
                    {formatPrice(
                      products.price.$numberDecimal -
                        (products.price.$numberDecimal *
                          products.discount.$numberDecimal) /
                          100
                    )}
                  </p>

                  <strike class="text-xl">
            ...
            <div className="text-xl">
              <b>stock: {products.qty.$numberDecimal} left</b>
            </div>
            <div className="text-l text-vnv-dark-grey">send from: Jakarta</div>
            <p className="text-vnv-dark-grey text-xl py-2 text-justify pe-10">
          ...
          <div class="w-[70%] border-[0.1rem] border-vnv-light-grey rounded-xl p-2 m-0 ms-5 me-10">
            <div className="p-5">
              ...
              <div className="text-end pe-10">
                <button className=" rounded bg-vnv-green-dark text-vnv-light hover:bg-vnv-green-primary py-2 px-5">
                  Add
                </button>
              </div>
            </div>
